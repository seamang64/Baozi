...
let rec out_class =
  { c_name=out_name; c_ptype=ClassType object_class; c_size=4; c_properties=[]; c_methods=[method_int; method_intln; method_string; method_stringln; method_ln]; c_ancestors=[]; c_generics=[]  }
...
and int_name =
  {x_name="Int"; x_def={d_kind=MethodDef (16, true); d_type=VoidType}}

and intln_name =
  {x_name="IntLn"; x_def={d_kind=MethodDef (20, true); d_type=VoidType}}

and string_name =
  {x_name="String"; x_def={d_kind=MethodDef (24, true); d_type=VoidType}}

and stringln_name =
  {x_name="StringLn"; x_def={d_kind=MethodDef (28, true); d_type=VoidType}}

and ln_name =
  {x_name="Ln"; x_def={d_kind=MethodDef (32, true); d_type=VoidType}}
