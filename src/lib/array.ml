...
let rec array_class =
  { c_name=array_name; c_pname=ClassType object_class; c_array=false; c_size=8; c_properties=[Prop(length, TempType "Int")]; c_methods=[method_equals; method_get_type; method_is; method_print]; c_ancestors=[] }
