...
let rec object_class =
  { c_name=object_name; c_ptype=VoidType; c_size=0; c_properties=[]; c_methods=[method_equals; method_get_type; method_is; method_print; method_constructor]; c_ancestors=[]; c_generics=[] }
...
and constructor_name =
  {x_name="%constructor"; x_def={d_kind=MethodDef (32, false); d_type=ClassType object_class}}
